...
semantic html gives meaning to the page.  It identifies what each part of the page consists of. 
...
Git is valuable to a team because it allows multiple people to work on a project at the same time.  It also makes it easier to find an error if one is made.  
