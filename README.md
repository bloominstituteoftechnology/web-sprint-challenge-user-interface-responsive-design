...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? Tags with meaning.

2. Name two big differences between `display: block;` and `display: inline;`. display:block adds a line break

3. What are the 4 areas of the box model? content, padding, margin, border

4. While using flexbox, what axis does the following property work on: `align-items: center`? on the cross axis

5. Explain why git is valuable to a team of developers. version control
