...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    It's a descriptive tag, it allows you to identify what's in the container without needing to class it.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
display:block will change an element to take up an entire row
display:inline will constrict the element to only take up the space it needs, allowing for something to be placed beside it
...
it allows multiple people to work on the same project without messing up the main code
