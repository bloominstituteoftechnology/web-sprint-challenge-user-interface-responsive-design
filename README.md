...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    It is html that describes what each element is and where it lies in a page
...
2. Name two big differences between ```display: block;``` and ```display: inline;```.
    ...
    inline: does NOT force new lines
...
5. Explain why git is valuable to a team of developers.
    ...
    it provides a history  of any modifications that were made.  It allows you to locate and fix any problems easily.  You are able to branch files so that you can work on something without affecting the master branch.  
