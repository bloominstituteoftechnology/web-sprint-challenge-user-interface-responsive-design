...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    Semantic HTML is more about the information on your page than the way it looks or presentation
2. Name two big differences between ```display: block;``` and ```display: inline;```.
     Block creates a line brake, inline does not / block margins are respected, inline they are not
