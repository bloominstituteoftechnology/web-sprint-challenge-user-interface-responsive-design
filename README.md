...
semnatic html is the construction material to build a webpage as wood is to build a home.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display block means to display like a colum to where as display inle would keep everything on the same line horizontillay.
...
git allows each dev to work on thier own branch of a file without effecting another team members work.
