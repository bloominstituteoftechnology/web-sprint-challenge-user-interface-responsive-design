...
2. Name two big differences between ```display: block;``` and ```display: inline;```.
    Block keeps things with a block of code the same. Doesn't tolerate HTML. It gives a line break before and after the element
    Inline is within the code. Takes up the full width available, with a new line before and after.
...
6. Git is helpful for team collaboration. Many people can look at the code and change it or add onto it, if it needs it. 
