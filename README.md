...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? it HyperText Markup Language its the basic scripting language

2. Name two big differences between ```display: block;``` and ```display: inline;```.
with inline the top and bottom margins/paddings are respectd
...
helps with functionality so other developers can see your code
