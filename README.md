...
provides version control and continuity that is especially useful in larger projects or projects with multiple developers. also useful for testing and debugging. tracked changes can allow a developer to roll back to a previous working version when things go wrong
