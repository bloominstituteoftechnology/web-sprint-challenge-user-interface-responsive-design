...
Semantic HTML uses HTML to give it structural meaning. It uses tags, id's, classes, and names.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display block allows you to set a height and a width to the property, display inline does not.
...
Git allows developers to be able to update and change code in one place, which is safe and saves the team time so they can be more efficient.
