...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    Semantic HTML to me would be the standard written form of HTML. Its best practice to write semantic HTML 
    so the code can be easier to read and understant. 

2. Name two big differences between ```display: block;``` and ```display: inline;```.
    Display block will take the whole width of the page while display inline will only take the space of the
    element.
...
5. Explain why git is valuable to a team of developers.
    Git is the industry standard for version control when programming. It helps to maintain a log of who is working with the code, keeping up with the most update code and it can save different versions of the same code.
