...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
  Semantic HTML means using specific elements for specific types of information. Not everything is a paragraph, header, or table. There are figures, links, buttons, etc. It is also possible to be specific in CSS without the excessive use of divs and spans.
2. Name two big differences between ```display: block;``` and ```display: inline;```.
Display block will elements stacked and respects all box-model properties. Display inline sits in a line and ignores width properties. 
3. What are the 4 areas of the box model?
Content, padding, border, margin
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
main axis
5. Explain why git is valuable to a team of developers.
Git allows collaborators to leave detailed breadcrumbs throughout their work flow, as well as get real time updates to the working files, live web updates and much more.
