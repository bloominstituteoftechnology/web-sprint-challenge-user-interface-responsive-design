...
-it gives meaning and structure to your webpages. 

2. Name two big differences between ```display: block;``` and ```display: inline;```.
-Block: Takes up the full width available.  Expands to fill their parent.
-Inline: Takes up only as much width as it needs. Contracts just enough to hold child.
...
-collaboration and version control are simple and concise
