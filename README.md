...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? Semantic HTML tells you the meaning of the information not just style.

2. Name two big differences between ```display: block;``` and ```display: inline;```. Block elements display items horizontally, inline elements display items left to right or vertically.
...
5. Explain why git is valuable to a team of developers. Git is valuable because it allows team members to contribute to the same project
