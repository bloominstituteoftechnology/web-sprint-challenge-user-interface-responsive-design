...
Semantic HTML is the proper usage and implementation of HTML.
...
Efficiency. Its give jr devlopers a safe enviroment to work in. While also eliminating time wasted in passing commits over a network.
