...
Semantic HTML helps with readibility of the html code by giving elements meaning. 

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Unlike "display:block", "display:inline" allows the element to not break text, and ignores length/width parameters.
...
It allows a team to collaborate on the same file, it then allowes them to merge their changes into a single program.
