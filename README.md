...
A. A semantic HTML element is used to construct a specific meaning in the webpage, whereas a nonsemantic HTML element is used in a much wider scope of uses in a webpage. 

2. Name two big differences between ```display: block;``` and ```display: inline;```.
A. display: block; allows you to establish a width, height and position, while display: inline; is limited to the size of the element and the direction of content flow. 

3. What are the 4 areas of the box model?
A. Margin, border, padding and content.

4. While using flexbox, what axis does the following property work on: ```align-items: center```?
A. The cross axis or vertical axis.

5. Explain why git is valuable to a team of developers.
A. It allows members of a team to quickly clone, create, and push their contributions to a centralized project repository. Contributions are also able to be reviewed before merging to the final product. 
