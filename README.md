...
Semantic HTML gives meaning rather than JUST presentation to your content
2. Name two big differences between ```display: block;``` and ```display: inline;```.

Block break onto a new line. Inline do not.
Block encompass inline elements
Can't set width or height to inline and can
with Block elements.

3. What are the 4 areas of the box model?
Content, padding, margin and border.
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
Along the cross axis, perpendicular to main axis

5. Explain why git is valuable to a team of developers.
Allows for version control. Enables us to track and save changes on the cloud. Tracks whose made changes. 
