...
-the big difference between the two is that display: block displays the elements as a block, while display: inline displays the elements on a page inline.
...
-it offers the type of preformance the most devolpers and teams need in terms of security, functionality, and flexibility.
