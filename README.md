...
the right way to markup an html file
Name two big differences between display: block; and display: inline;.
block operates in a block while inline operates along a line
...
allows a team to use seperate branches to avoid clashing code
