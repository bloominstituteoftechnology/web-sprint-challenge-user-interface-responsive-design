...
2. Name two big differences between ```display: block;``` and ```display: inline;```.
    ...
    display: block creates a block element, meaning it takes up all space next to it. display: inline creates an inline element, meaning it will embed itself into the parent element.
...
5. Explain why git is valuable to a team of developers.
    ...
    Git allows us to view a timeline of changes to a repository. This allows teams to see where bugs were introduced, and easily find them. Git also allows coders to clone their own repo and make changes, then a project manager can merge it into the main repository. This way changes are regulated better. 
