...
semantic HTML helps provide meaning to your code. 

2. Name two big differences between ```display: block;``` and ```display: inline;```.
inline only uses width, block deals with height as well.
...
you can work off different branches and different parts of the code and not mess with the overall code until you merge into the master.
