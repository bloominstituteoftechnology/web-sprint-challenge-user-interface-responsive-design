...
Its a way to breakdown your HTML in plain english its provides clarity.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
```display:block; ---> takes up the entire width of the page
                  ---> a new line before and after
...
It allows multiple people to work on the same code while documenting all the changes done to it and saving older versions incase it breaks we can go back to an older version and start over.
