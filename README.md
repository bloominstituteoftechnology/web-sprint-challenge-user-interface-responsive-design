...
- Semantic HTML elements add readability to websitres and assist with accessability by breaking down web pages into different parts. These semantic elements do not render on the page and so are strictly used to make the code cleaner and enhance accessability.

2. Name two big differences between `display: block;` and `display: inline;`.
   -display block puts a single element (or group of elements depending on the selector used) on a line. Display inline adds the element/ group of elements to a line which allows other content to exist on that same line.
...
5. Explain why git is valuable to a team of developers.
   -git allows developers to utilize something called version control. This allows easy rollbacks of updates and changes in the event of a bug.
